  ...
  return (
    <div>
      ...
      <Link to="/products" className="block">
        {/* Desktop Banner */}
        <div
          className="hidden md:flex text-white p-12 rounded-lg mb-8 bg-gradient-to-r from-blue-500 to-purple-600 bg-contain bg-no-repeat bg-center relative flex-col justify-center items-center text-center h-[32rem] cursor-pointer"
        ...
        {/* Mobile Banner */}
        <div
          className="md:hidden flex text-white p-8 rounded-lg mb-8 bg-gradient-to-r from-blue-500 to-purple-600 bg-contain bg-no-repeat bg-center relative flex-col justify-center items-center text-center h-64 cursor-pointer"
