  ...
  return (
    <div>
      ...
      <Link to="/products" className="block">
        {/* Desktop Banner */}
        <div
          className="hidden md:flex text-white p-12 rounded-lg mb-8 bg-gradient-to-r from-blue-500 to-purple-600 bg-cover bg-center relative flex-col justify-center items-center text-center h-85 cursor-pointer"
